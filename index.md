...
<div style="margin-top: 50px;">
    <div style="display: flex; align-items: center; margin-bottom: 20px;">
        <h2 style="margin: 0; color: #333; font-weight: 700;">🚧 Dự án sắp tới</h2>
        <div style="flex-grow: 1; height: 1px; background: #eee; margin-left: 20px;"></div>
    </div>
    
    <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; color: #7f8c8d; text-align: center; border: 1px dashed #ddd;">
